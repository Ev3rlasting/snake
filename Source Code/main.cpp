...
void resize (int w, int h)
{
	...
	glLoadIdentity();
	gluPerspective(45.0, (double)winW / (double)winH, 5, 300);
...
void setup() 
{
	...
	glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_DECAL); //¥u¦Ò¼{Texture ÃC¦â
...
void drawScene()
{
	...
	glBegin(GL_LINES);//»­×ø±êÖá ·½±ã²Ù×÷
	//	glLineWidth(0.3);
	glColor3f(1.0f,0.0f,0.0f);
	glVertex3f(-5 , 0.0f, 0.0f);
	glVertex3f(5,  0.0f,  0.0f);
	glVertex3f(5,  0.0f,  0.0f);
	glVertex3f(4,  1.0f,  0.0f);
	glVertex3f(5,  0.0f,  0.0f);
	glVertex3f(4,  -1.0f,  0.0f);

	glColor3f(0.0f,5,0.0f);
	glVertex3f(0.0f,-5,0.0f);
	glVertex3f(0.0f,5,0.0f);
	glVertex3f(0.0f,5,0.0f);
	glVertex3f(0.0f,4,1.0f);
	glVertex3f(0.0f,5,0.0f);
	glVertex3f(0.0f,4,-1.0f);

	glColor3f(0.0f,0.0f,5);
	glVertex3f(0.0f,0.0f,-5);
	glVertex3f(0.0f,0.0f,5);
	glVertex3f(0.0f,0.0f,5);
	glVertex3f(0.0f,1.0f,4);	
	glVertex3f(0.0f,0.0f,5);
	glVertex3f(0.0f,-1.0f,4);
